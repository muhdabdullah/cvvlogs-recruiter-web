  ...
  return (
    <>
      ...
      <div className="row mt-5 mb-2">
        ...
        <p>
          The terms and conditions of this Policy govern your use of 'cvvlogs',
        ...
        <p>
          You hereby confirm to cvvlogs that: (a) you have reached the age of
          15, (ii) are an emancipated minor under the laws of your jurisdiction
          of domicile or residence, (iii) have the consent of your parent or
          legal guardian, or (iv) otherwise have the power and authority to
          enter into and perform your obligations under these Terms and
          Conditions.
        </p>
        <h6 style={{ fontWeight: 800, textTransform: "uppercase" }}>
        ...
        <p>
          cvvlogs is never involved in any communication taking place between
        ...
        <p>
          <p>
            ...
            fees charged to Candidates for progress tracking on job applied
            shall be paid monthly and automatically charged to the Candidate
            debit or credit card. Recruiters on the other hand are charged a
            one-time fee to shortlist, message and communicate with a candidate.
          </p>
          <p>
            Payment made by Recruiters are refundable only if the Candidate
            shortlisted by the Recruiter is unavailable. Recruiters are advised
            to contact us within 48 hours via support@cvvlogs.com to claim
            refund.
          </p>
          <p>
            All sales are final and refunds are solely at the discretion of
            cvvlogs. In the event that the Client makes an error in any
            payment(s) to cvvlogs or any payment is provided to cvvlogs in
            excess of the amount payable or due by the Client, cvvlogs may at
            its sole discretion:
          </p>
          <p>
        ...
        <p>
          cvvlogs makes no implied or express representations or warranties
          ...
          on information provided on the Platform by anyone other than cvvlogs.
        </p>
        <p>
          cvvlogs reserves the right, in its sole discretion, to remove User
          Content from the Platform; however, no obligation exists on cvvlogs to
          definitively undertake any such action.
        </p>
        <p>
          cvvlogs shall, in no manner or form, be responsible for the Platform
          ...
          by cvvlogs with regards toٖ:
        </p>
        <h6 style={{ fontWeight: 800, textTransform: "uppercase" }}>
          HARRASMENT AND THEFT POLICY
        </h6>
        <p>
          cvvlogs maintains a strict harassment and identity theft policy in
          compliance with the standard regulations. Under no circumstance shall
          cvvlogs be responsible for any form of harassment or identity theft
        ...
        <p>
          cvvlogs values and understand the confidentiality of your information
          ...
          breach of this clause by the User, cvvlogs shall not be liable for any
          damage or loss that will occur as a result of the breach of
          confidentiality.
        </p>
        <p>
        ...
        <p>
          No liability shall be incurred by cvvlogs for any loss, damage, delays
          or failures arising out of use of the Platform and attributable to
          acts beyond cvvlogs control, including but not limited to acts of God,
          changes to laws, embargoes, wars, terrorist acts, acts or omissions of
          third-party’s, epidemics, explosions, socio-economic instability,
          natural calamities, power outages, weather conditions, acts of
          hackers, internet issues service providers, any outside forces that
          disrupt the functionality of the Platform and acts or omissions of the
        ...
        <p>
          You agree to defend, indemnify and hold cvvlogs, its affiliates, and
          ...
          the law or of these Terms and Conditions. cvvlogs reserves the right,
          ...
          you agree to cooperate with cvvlogs defense of such claim.
        </p>
        <h6 style={{ fontWeight: 800, textTransform: "uppercase" }}>
          NO WARRANTIES
        </h6>
        ...
        <p>
          ...
          for in these Terms and Conditions, cvvlogs reserves the right to
          terminate, change, suspend or discontinue any aspect of the Site or
          the Site's services at any time. Further, you agree that cvvlogs shall
          ...
          affect any right or relief to which cvvlogs may be entitled at law or
