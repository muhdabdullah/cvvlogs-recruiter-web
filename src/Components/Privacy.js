  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <p>
          cvvlogs takes the privacy of its users very seriously. We strive to
          ...
          to the cvvlogs website and mobile application does not apply to
          information we collect in any other form. The cvvlogs site contains
        ...
        <h6 style={{fontWeight: 800, }}>Usage and Information Collection by cvvlogs</h6>
        <p>
        ...
        <p>
          We also gather information about our users' use of cvvlogs, such as
        ...
        <h6 style={{fontWeight: 800, }}>Our Use of your Information</h6>
        <p>
          We use the information we gather on cvvlogs, whether personal,
          demographic, aggregate or technical, for the purpose of operating and
          improving the cvvlogs web site, creating a positive user experience,
        ...
        <h6 style={{fontWeight: 800, }}>Disclosure of Personal Information to Third Parties</h6>
        <p>
        ...
        <p>
          ...
          notified via email or through a prominent notice posted on the cvvlogs
          Website.
        </p>
        <p>
          ...
          party web site the information collected here is governed by cvvlogs
          and our privacy practices.
        </p>
        <h6 style={{fontWeight: 800, }}>Personal Information on Resumes and Profiles</h6>
        <p>
        ...
        <p>
          You may remove your resume on cvvlogs or delete your profile on
          cvvlogs at any time, but, employers, recruiters and others who have
        ...
        <h6 style={{fontWeight: 800, }}>Posting to Public Areas of cvvlogs</h6>
        <p>
          Please remember that if you post any of your personal information in
          public areas of cvvlogs such as the searchable resume database, such
        ...
        <h6 style={{fontWeight: 800, }}>Use of Cookies</h6>
        <p>
        ...
        <p>
          ...
          to a specific page. For example, if you personalize cvvlogs pages, or
          ...
          and a more personalized site experience. When you return to cvvlogs,
        ...
        <p>
          ...
          hinder performance and negatively impact your experience on cvvlogs.
        </p>
        <h6 style={{fontWeight: 800, }}>Modification of Your Information</h6>
        <p>
          You may review, correct, update or change your cvvlogs account profile
          at any time on your 'My Settings' page or by emailing our webmaster
          at'support@cvvlogs.com'or by calling customer support at 1 (866)
          955-9001. These points of contact also allow you to edit your
          ...
          from cvvlogs or third parties at the time you created a cvvlogs
          account, but subsequently change your mind, you may opt-out by editing
          your cvvlogs Account Profile as described above. If you previously
          opted not to receive such communications, you may later optin by
          editing your cvvlogs Account Profile as well.
        </p>
        <p>
          We retain indefinitely all the information we gather about you in an
          effort to make your repeat use of cvvlogs, practical, and relevant. Of
          course, you can delete your resume from cvvlogs online database and
          close your cvvlogs account at any time by informing us via our
          feedback form. In such an event we will remove all our copies of your
          resume from cvvlogs, your cvvlogs account information and remove your
          profile, except for an archival copy which is not accessible on the
          Internet.
        </p>
        <h6 style={{fontWeight: 800, }}>Security of the Profile Information</h6>
        <p>
        ...
        <h6 style={{fontWeight: 800, }}>Use of Material</h6>
        <p>
          The contents of cvvlogs (the "Website" and “Aps”) such as text,
        ...
        <h6 style={{fontWeight: 800, }}>Children's use of cvvlogs</h6>
        <p>
          The cvvlogs web site is not intended for children under 15 years of
          age. We do not knowingly collect personal information from children
          under 15.
        </p>
        <h6 style={{fontWeight: 800, }}>Privacy Policy Modifications</h6>
        <p>
          If we decide to materially change our Privacy Policy for cvvlogs, we
        ...
        <h6 style={{fontWeight: 800, }}>Contact Information</h6>
        <p>
          cvvlogs is the name under which Scorpius Holding LLC., a Florida based
          corporation with its principal place of business at 200 Booth Rd.
          Suite A Ormond Beach, FL 32174 and certain of its affiliated companies
          worldwide, do business. Scorpius Holding LLC. is the legal entity
          which determines the purposes and means of processing the information
          gathered at www.cvvlogs.com. You can also contact us at
          support@cvvlogs.com.
        </p>
        <h6 style={{fontWeight: 800, }}>Billing & Refund Policy</h6>
        <p>
          cvvlogs charges a fee to both the recruiter and the candidate. The
        ...
        <p>
          ...
          contact us within 48 hours via support@cvvlogs.com to claim refund.
        </p>
        <p>
          All sales are final and refunds are solely at the discretion of
          cvvlogs. In the event that the Client makes an error in any payment(s)
          to cvvlogs or any payment is provided to cvvlogs in excess of the
          amount payable or due by the Client, cvvlogs may at its sole
          discretion:
        </p>
        <p>
